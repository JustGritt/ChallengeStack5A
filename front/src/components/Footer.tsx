            ...
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                    ...
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-2">
                        <div>
                            ...
                            <ul className="text-gray-500 dark:text-gray-400 font-medium">
                                <li className="mb-4">
                                    <a target="_blank" href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" className="hover:underline ">Github</a>
                                </li>
                                <li>
                                    <a target="_blank" href="https://dis.cord.gift/" className="hover:underline">Discord</a>
                                </li>
                            </ul>
                        </div>
                        <div>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">
                        © 2023 <a href="https://odicylens.com/" className="hover:underline">Odicylens</a>. All Rights Reserved.
                    </span>
                    <div className="flex mt-4 sm:justify-center sm:mt-0">
                        <a target="_blank" href="https://dis.cord.gift/" className="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
                        ...
                        <a target="_blank" href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" className="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
