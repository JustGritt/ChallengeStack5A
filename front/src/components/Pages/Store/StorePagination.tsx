...
export default function Stores() {
    ...
    useEffect(() => {
        ...
        fetchStores()
    }, [userConfig, storesFetched, parsedSession, router]);
        ...
        <section>
            {
                stores ? (
                    ...
                    <section className="grid place-items-center">
                        ...
                        <Link href="/affiliate" className="mb-8 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-6 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
                            Become an affiliate
                        </Link>
                    </section>
                )
